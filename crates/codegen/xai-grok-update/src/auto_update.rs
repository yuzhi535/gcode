...
///
/// gcode ships from its own GitHub releases (internal update channel), so every
/// channel resolves to the same latest-release installer; x.ai's channel-aware
/// bootstrap scripts are intentionally not used.
...
/// Download and install grok from GitHub Releases (yuzhi535/gcode).
///
